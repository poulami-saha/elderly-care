  ...
  return (
    <>
      <div className="mx-auto max-w-[1240px] flex flex-col items-center font-serif">
        <img src={login} className="h-60 w-2/3  mt-6 border rounded-2xl" />
      ...
      <div className="mx-auto max-w-[1240px] flex flex-col md:flex-row justify-between space-y-4 md:space-y-0 md:space-x-24 my-6 font-serif">
        ...
        <div className="w-auto md:w-1/2 border border-green-200 rounded-2xl p-16 h-[300px]">
          <p className="text-xl font-serif font-bold">
            Monthly costs for a caregiver
          </p>
          <p className="my-4 font-bold text-2xl">
            <span className="text-3xl">From €2,299</span> /Month
          </p>
        </div>
      </div>
    </>
